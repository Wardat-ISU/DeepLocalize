...
from keras.layers import Dense, Conv2D, Flatten, Lambda, Dropout, MaxPooling2D, Activation
...
history = model.fit(x_train, y_train, batch_size=batch_size, epochs=epochs,
                    ...
                    keras.callbacks.backpropagation(x_train, y_train, len(model.layers),batch_size, start_time)
                    ]
